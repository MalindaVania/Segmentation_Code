...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--save_latest_freq', type=int, default=5, help='frequency of saving the latest results')
        ...
        self.parser.add_argument('--beta1', type=float, default=0.02, help='momentum term of adam') #0.02 or 0.5
        ...
        self.parser.add_argument('--lambda_A', type=float, default=4.0, help='weight for cycle loss (A -> B -> A)')
        self.parser.add_argument('--lambda_B', type=float, default=4.0, help='weight for cycle loss (B -> A -> B)')
        self.parser.add_argument('--lambda_C', type=float, default=4.0, help='weight for cycle loss (A -> B -> A)')
        self.parser.add_argument('--lambda_D', type=float, default=4.0, help='weight for cycle loss (B -> A -> B)')
