...
class BaseOptions():
    ...
    def initialize(self):
        ...
        #self.parser.add_argument('--weight_2',type=int,default=100,help='weight of left kidney')
        #self.parser.add_argument('--weight_3', type=int, default=10, help='weight of right kidney')
        #self.parser.add_argument('--weight_7', type=int, default=100, help='weight of stomach')
        #self.parser.add_argument('--test_CT_dir', type=str, default='/home/mvania/Seg-Net/Datasets/CT/',help='for test seg')
